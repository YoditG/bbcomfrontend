                ...
                <div style={Object.assign({}, { position: "relative" }, this.props.style, { width: this.state.width + cameraControlStyle.width, height: this.state.height })} >
                    <div style={{ position: "relative", display: "flex", flexDirection: "column", width: "100%" }}>
                        ...
                        <div className="camera-container" style={cameraStyle}>
                            ...
                            <div style={{ display: "flex", flexDirection: "column", justify: "space-between", position: "relative"}}>
                                <div>
                                    {
                                ...
                                <div style={{ display: "flex", flexDirection: "column", height: "100%", alignContent: "center" }}>
                                    <div style={{ display: "flex", flexDirection: "row", position: "relative", marginRight: 30, justifyContent: "center", alignContent: "center", width: "100%" }}>
                                        <div style={{ display: "flex", flexDirection: "row", justifyContent: "center" }}>
                                            <CaptureButton onClick={this._onCapture} />
                                        </div>
                                    </div>
                                    <div style={{ width: "100%", position: "relative", display: "flex", flexDirection: "row", justifyContent: "center", marginTop: "15px" }}>
                                        <div style={{ display: "flex", flexDirection: "row", justifyContent: "center" }}>
                            ...
                            {/*<div style={Object.assign({}, cameraControlStyle, { position: "relative", display: "flex", flexDirection:"column", height: this.state.height, justifyContent: "flex-end", border: "solid green 1px" })} >
                        <div style={{ display: "flex", flexDirection: "column", position: "relative", marginRight: 30, justifyContent: "center", border: "solid 1px yellow" }}>
                            <CaptureButton onClick={this._onCapture} />
                        </div>
