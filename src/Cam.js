...
class Cam extends Component {
  ...
  updateWindowDimensions() {
    ...
    //         --------------------- adjust screensize here ---------------------------


    //window.innerHeight
    this.setState({ width: window.innerWidth, height: "500px" });
  }
  render() {
    return (
      <MuiThemeProvider muiTheme={getMuiTheme(darkBaseTheme)}>
        <div className="App">
          ...
          <div>v {version}</div>
          <div>
            <a href="https://github.com/andrewbhy/react-camera">https://github.com/andrewbhy/react-camera </a></div>
          <div style={{ display: "flex", flexDirection: "row", justify: "center", width: "100%", border: "solid grey 2px" }}>
            <div>
              <Camera
                onCapture={onCapture}
                emulation={false}
                ...
                emulationSrc={"SampleVideo_1280x720_1mb.mp4"} />
            </div>
          </div>
          <div>
